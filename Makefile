...
hard_smooth_sort_test: 
	gcc ./sorting_algz.c ./tests.c ./main.c -o smooth_sort
	./smooth_sort smooth hard > smooth_sort_result_hard.txt
	rm smooth
	
hard_patience_sort_test: 
	gcc ./sorting_algz.c ./tests.c ./main.c -o patience_sort
	./patience_sort patience hard > patience_sort_result_hard.txt
	rm patience
